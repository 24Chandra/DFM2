...
$flowUnit = mysqli_query($dbhandle, "SELECT COUNT(DISTINCT(unit_id)) as unitFlow FROM serial_data_results "
        . "WHERE SUBSTR(FINISH,1,8) = '$convdate' AND duplicate = '' and unit_id != ''and gross_deliver != '' AND site_id = '$sitePos'  ORDER BY unit_id ASC");
...
$bcsite_id1 = mysqli_query($dbhandle, "SELECT unit_id FROM serial_data_results  "
        . "WHERE  site_id = '$sitePos' AND SUBSTR(FINISH,1,8) = '$convdate' AND duplicate = '' and gross_deliver != '' and unit_id != ''  GROUP BY unit_id ORDER BY unit_id ASC LIMIT 1");
$hbcsite_id1 = mysqli_fetch_array($bcsite_id1);

$bcsite_id2 = mysqli_query($dbhandle, "SELECT unit_id FROM serial_data_results  "
        . "WHERE site_id = '$sitePos' AND SUBSTR(FINISH,1,8) = '$convdate' AND duplicate = '' and gross_deliver != '' and unit_id != ''  GROUP BY unit_id ORDER BY unit_id ASC LIMIT 1,1");
$hbcsite_id2 = mysqli_fetch_array($bcsite_id2);

$bcsite_id3 = mysqli_query($dbhandle, "SELECT unit_id FROM serial_data_results "
        . "WHERE site_id = '$sitePos' AND SUBSTR(FINISH,1,8) = '$convdate' AND duplicate = '' and gross_deliver != '' and unit_id != ''  GROUP BY unit_id ORDER BY unit_id ASC LIMIT 2,1");
$hbcsite_id3 = mysqli_fetch_array($bcsite_id3);

$bcsite_id4 = mysqli_query($dbhandle, "SELECT unit_id FROM serial_data_results "
        . "WHERE site_id = '$sitePos' AND SUBSTR(FINISH,1,8) = '$convdate' AND duplicate = '' and gross_deliver != '' and unit_id != ''  GROUP BY unit_id ORDER BY unit_id ASC LIMIT 3,1");
...
for ($w = 0; $w <= 23; $w++) {
    ...
    $rdata1 = mysqli_query($dbhandle, "SELECT IFNULL(SUM(gross_deliver),0) AS total1 FROM serial_data_results "
            . "WHERE site_id = '$sitePos' AND SUBSTR(FINISH,1,8) = '$convdate' and SUBSTR(finish,10,2) = '$newmonth' AND duplicate = '' and gross_deliver != '' and unit_id != '' "
